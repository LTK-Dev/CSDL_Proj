...
function function_alert() { 
    ...
    echo "<script>alert('Your user has been updated');</script>"; 
...
if(isset($_POST['submit']))
{
    ...
    else
    {
        ...
        else
        {
            ...
            $sql = "UPDATE users SET username='$username', f_name='$fname', l_name='$lname', email='$email', phone='$phone', password='$password' WHERE u_id='$user_upd'";
            $result = mysqli_query($db, $sql);

            if($result)
            {
                $success = '<div class="alert alert-success alert-dismissible fade show" role="alert">
    <strong>User Updated!</strong> Your password has been successfully updated.
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
</div>';
                function_alert();
                // Chuyển hướng trình duyệt đến trang update_users.php
                header("refresh:1;url=update_users.php");
